...
import backGround from "../../../Multimedia/nick-fewings-Uz9w7XZnEkA-unsplash.jpg"

const ShopAll = () => {
    return (
        <ProductItems pageName={'ShopAll'}
                      bgImg={backGround}
                      productsArray={products}
        />)
}
export default ShopAll;
{/*bgImg={'https://static.wixstatic.com/media/11062b_24409e13fc004ed1acf25161830fc9e6~mv2.jpg/v1/fill/w_1522,h_411,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/11062b_24409e13fc004ed1acf25161830fc9e6~mv2.jpg'}*/}
