            ...
            <div className={styles.background_container}>
                <div className={styles.bottomOfHomePage_containerFeedbackFormContacts}>
                    <div className={styles.feedbackForm}>
                        <div className={styles.feedbackForm_sendAMess}>                                                         {/*ЗАГОЛОВОК*/}
                            <span>FOR ANY QUESTIONS, PLEASE SEND US A MESSAGE</span>
                        </div>
                        <img src={redZigzag} alt=""/>
                        <form action="src/Components/Menu/Home/Home" className={styles.feedbackForm_form}>                      {/*ФОРМА*/}
                            ...
                            <input type="submit" value="Submit" className={styles.form_button}/>                                {/*КНОПКА Submit*/}
                        </form>
                    </div>
                    <div className={styles.contacts}>                                                                           {/*КОНТАКТИ*/}
